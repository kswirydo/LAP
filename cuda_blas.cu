                      ...
                      double *a)
{
  ...
  cusparseDcsric02_bufferSize(handle_cusparse, 
                              n, 
                              nnzA,
                              descrM, 
                              a,
  ...
  cusparseDcsric02_analysis(handle_cusparse,
                            n, 
                            nnzA, 
                            descrM,
                            a, 
  ...
  cusparseDcsrsv2_analysis(handle_cusparse, 
                           CUSPARSE_OPERATION_NON_TRANSPOSE, 
                           n, 
                           nnzA, 
                           descrL,
  ...
  // step 5: M = L * L'
  cusparseDcsric02(handle_cusparse, 
                   n, 
                   nnzA, 
                   descrM,
                   a, 
